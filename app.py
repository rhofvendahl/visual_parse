...
print('start of app.py, mem:', memory() / 1000000, "MB")
# print("mem:", memory() / 1000000000, "GB")
from flask import Flask, render_template, request, jsonify
# print("just imported flsk stuff, about to import model, mem:", memory() / 1000000000, "GB")
...
model = PretrainedModel('data/event2mind.tar.gz', "event2mind")
event2mind_predictor = model.predictor()
...
# import spacy
# print("about to load encorewebsm, mem:", memory() / 1000000000, "GB")
# print('Loading en_core_web_sm...')
# nlp = spacy.load('en_core_web_sm')
# print('Load complete.')
print("mem:", memory() / 1000000, "MB")
