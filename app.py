...
def stacksize(since=0.0):
    ...
    ################################################################
print('MEMORY pre flask and stuff:', memory() / 1000000, "MB")

from flask import Flask, render_template, request, jsonify
print('MEMORY post flask pre modl:', memory() / 1000000, "MB")

from modl import Model, nlp
print('MEMORY post modl:', memory() / 1000000, "MB")
...
print('MEMORY right about to run:', memory() / 1000000, "MB")
